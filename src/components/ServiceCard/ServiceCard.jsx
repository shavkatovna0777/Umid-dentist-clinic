          ...
          >
            <div className="relative p-3">
              ...
              <div className="relative flex justify-center -mt-8 mx-6">
                <h3 className="inline-block whitespace-nowrap w-[80%] text-darkBlue bg-white  py-3.5 text-center text-xl font-bold text-gray-800 rounded-lg shadow-lg transition-all  duration-300 group-hover:shadow-xl">
                  {service.title}
                </h3>
              </div>
            </div>
