    ...
    <section className="bg-[url(./assets/images/inside_img4.jpg)] bg- w-full bg-cover min-h-[800px] bg-no-repeat ">
      <div className="container">
        <div className="parent flex items-center justify-between h-full">
          ...
          data-aos-once="true">
            <div className="left-wrapper bg-white p-[60px_60px_65px_60px] w-[570px] slg:w-[700px] h-auto rounded-[15px] shadow-[10px_8px_35px_rgba(49,49,49,0.08)] transition-all duration-300 ease-in-out bg-[10px_15px] mx-[10px] my-[90px] md:h-[95%] md:w-[100%] md:p-[17px_30px_35px_30px]">
