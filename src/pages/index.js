...
export const ArticlesPage = lazy(() => import("./ArticlesPage/ArticlesPage.jsx"));
export const ArticleSingle = lazy(() => import("./ArticleSingle/ArticleSingle.jsx"));
export const DoctorsSingle = lazy(() => import("./DoctorsSingle/DoctorsSingle.jsx"));
